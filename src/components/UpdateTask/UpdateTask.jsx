...
export const UpdateTask = ({ func, setOpenUpdateTask }) => {
    ...
    <>
      <div>
        <form className="theForm">
          <div onClick={() => setOpenUpdateTask(false)} className="icon">
            <AiFillCloseCircle />
          </div>
          <div className="addTask">Update Tasks</div>
          <input
            type="text"
            name="title"
            value={title}
